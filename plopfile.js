    ...
    actions: (data) => {
      const actions = [
        ...
        },
        {
          type: 'add',
          path:
            'src/components/{{properCase name}}/{{properCase name}}.test.js',
          templateFile: 'internals/plop-templates/component/component.test.js.hbs',
        },
        {
          type: 'add',
          path:
            'src/components/{{properCase name}}/{{properCase name}}.module.css',
          templateFile: 'internals/plop-templates/component/component.module.css.hbs',
        },
        {
          type: 'add',
        ...
        {
          type: 'add',
          path: 'src/components/{{properCase name}}/{{properCase name}}.md',
          templateFile: 'internals/plop-templates/component/component.md.hbs',
        },
        {
          type: 'add',
      ...
      if (data.wantMessages) {
        actions.push({
          type: 'add',
          path:
            'src/components/{{properCase name}}/{{properCase name}}.messages.js',
          templateFile: 'internals/plop-templates/component/component.messages.js.hbs',
        });
      }
  ...
  plop.setGenerator('context', {
    ...
    actions: (data) => {
      const actions = [
        {
          type: 'add',
          path: 'src/contexts/{{dashCase name}}-context.js',
        ...
        },
        {
          ...
          path: 'src/contexts/index.js',
          pattern: `/* PLOP_INJECT_IMPORT */`,
          template: `import { use{{properCase name}}, {{properCase name}}Provider } from './{{dashCase name}}-context';`,
        },
        {
          type: 'append',
          path: 'src/contexts/index.js',
